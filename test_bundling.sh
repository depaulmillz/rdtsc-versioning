...
# SKIPLISTLOCK:
benchs="luigi.skiplistlock.rq_bundle.ts.out luigi.skiplistlock.rq_bundle.rdtsc.out luigi.skiplistlock.rq_bundle.rdtscp.out"
  # BST: benchs="luigi.bst.rq_bundle.rdtsc.out luigi.bst.rq_bundle.rdtscp.out luigi.bst.rq_bundle.ts.out"
  # CITRUS: benchs="luigi.citrus.rq_bundle.rdtsc.out luigi.citrus.rq_bundle.rdtscp.out luigi.citrus.rq_bundle.ts.out"
